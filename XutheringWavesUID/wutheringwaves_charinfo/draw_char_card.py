...
async def draw_char_detail_img(
    ...
    if skill_branch:
        ...
        weapon_bg_temp_draw.text((320, 207), f"{skill_branch.branchName[:4]}", "white", waves_font_30, "lm")
        weapon_bg_temp_draw.text((320, 257), f"{skill_branch.branchName[5:]}", "white", waves_font_30, "lm")
